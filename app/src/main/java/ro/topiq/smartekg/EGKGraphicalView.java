...
public class EGKGraphicalView extends View {
    ...
    final int m_nMaxAmplitude = 20000;
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(m_nDistance, m_nDistance, m_metrics.widthPixels - m_nDistance, m_metrics.heightPixels - m_nDistance*3, m_paint);
        ...
        canvas.drawLine(
                m_nDistance,
                m_metrics.heightPixels / 2 + m_nDistance / 2,
